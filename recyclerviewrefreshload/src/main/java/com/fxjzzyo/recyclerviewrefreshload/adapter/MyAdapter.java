package com.fxjzzyo.recyclerviewrefreshload.adapter;
...
import com.fxjzzyo.recyclerviewrefreshload.R;

import java.util.ArrayList;
import java.util.List;

/**
 * Created by fanlulin on 2019-07-19.
 */
public class MyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.item, parent, false));
        } else {
