package com.fxjzzyo.simpleimagetest.util
...
/**
 *Created by fanlulin on 2019-08-05.
 */
class ImageCompress {
    ...
    fun compressImageDataWithSize(context: Context, rawData: ByteArray, limitDataSize: Int): ByteArray? {
        ...
        if (format == ImageFormat.JPG) {
            ...
            try {
                ...
                e.printStackTrace()
                Log.d("tagg","-----compressImageDataWithSize------"+e.message);
            }
    ...
    private fun compressGifDataWithSampleCount(context: Context, rawData: ByteArray, sampleCount: Int): ByteArray? {
        ...
        try {
            ...
            e.printStackTrace()
            Log.d("tagg","-----compressGifDataWithSampleCount------"+e.message);
        }
